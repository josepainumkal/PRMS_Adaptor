...
animationToNetcdf.animation_to_netcdf(os.getcwd()+'/prms/output_files/animation.out.nhru', os.getcwd()+'/prms/outputs/parameter.nc', os.getcwd()+'/prms/outputs/animation.nc', limit=547000, event_emitter=ee)
